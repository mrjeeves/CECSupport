...
// gives a nervous customer no clue why it failed to paint; this renders the
// error into a fixed overlay so it can be read off the screen (and relayed to
// their technician), instead of a silent blank.
